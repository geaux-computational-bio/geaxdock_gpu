...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      real w(1), x(3, 1), y(3, 1), u(3, 3), t(3), rms, sigma
      real r(3, 3), xc(3), yc(3), wc, a(3, 3), b(3, 3), e0, 
...
c 228 "rms.for"
   10 do 15 l = 1, 3, 2
      ...
      j = 1
      if (abs(ss1) .ge. abs(ss3)) goto 12
      j = 2
      if (abs(ss3) .ge. abs(ss6)) goto 13
   11 j = 3
      goto 13
   12 if (abs(ss1) .lt. abs(ss6)) goto 11
   13 d = zero
      j = 3 * (j - 1)
      do 14 i = 1, 3
      k = ip(i + j)

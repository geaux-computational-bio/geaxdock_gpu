...
void OptimizeProtein(const Protein0 *, Protein *, const EnePara0 *,
                     const Ligand0 *, const ComplexSize);
...
void PrintMoveRecord(const LigRecord *, const int, const int, const int,
                     const int, const int);
...
void PrintRepRecord(const LigRecord *, const int, const int, const int,
...
void PrintDataSize(const Ligand *, const Protein *, const Psp *, const Kde *,
                   const Mcs *, const EnePara *);
void PrintSummary(const InputFiles *, const McPara *, const Temp *,
                  const McLog *, const ComplexSize *);
...
void SimilarityCorrelation(
    vector<vector<LigRecordSingleStep> > multi_reps_records, Ligand *lig,
